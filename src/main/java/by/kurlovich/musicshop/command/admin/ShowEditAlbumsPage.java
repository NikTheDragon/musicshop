...
public class ShowEditAlbumsPage implements Command {
    ...
    public ShowEditAlbumsPage(AlbumReceiver receiver) {
    ...
    public CommandResult execute(HttpServletRequest request) throws CommandException {
        try {
            ...
            if (accessValidator.validate(accessRoles, userRole)) {
                ...
                List<Genre> genreList = genreReceiver.getAllGenres();
            ...
            throw new CommandException("Exception in Show Edit Albums Page.\n"+e, e);
        }
    }
}
